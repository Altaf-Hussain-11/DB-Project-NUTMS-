...
export function NotificationProvider({ children }: { children: React.ReactNode }) {
  ...
  // Default dummy notifications shown on first load
  const now = Date.now();
  const defaults: AppNotification[] = [
    {
      id: `${now}-1`,
      title: 'Welcome to NUTMS',
      message: 'Welcome to Namal University Transport Management System. Have a safe journey!',
    ...
    },
    {
      ...
      message: 'Your bus route "Campus to Mianwali City" is scheduled for tomorrow at 08:00 AM.',
    ...
    },
    {
      ...
      message: 'Your special trip request to HEC Islamabad has been approved by the admin.',
    ...
    },
    {
      ...
      message: 'Bus MWM-A101 on Campus to Mianwali City route is running 10 minutes late today.',
    ...
    },
    {
      ...
      message: 'The Kundian to Campus route schedule has been updated. New departure time is 06:45 AM.',
